...
public class AnswerServiceImpl implements AnswerService {
    ...
    public ServerResponse addAnswer(int qid,AnswerDto answerDto) throws IOException {
        ...
        System.out.println(HttpStatus.OK+"hello");
    ...
    public ServerResponse approveAnswer(int aid){
        ...
        emailService.sendusermail(user.getEmail(),"your answer aproved","your answer is aproved");
        answerRepos.save(answers);
   ...
   public ServerResponse deleteAnswer(int aid,String message){
	   Answers answers=answerRepos.findByA_id(aid);

	   User user=answers.getUser();
       emailService.sendusermail(user.getEmail(),"your answer deleted",message);
