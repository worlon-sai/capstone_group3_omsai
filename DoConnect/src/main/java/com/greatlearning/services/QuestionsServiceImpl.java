...
public class QuestionsServiceImpl implements QuestionService {
    ...
    public ServerResponse approveQuestion(int qid) {
        ...
        emailService.sendusermail(user.getEmail(),"your question aproved by admin","aproved");
    ...
    @Override
    public ServerResponse deleteQuestion(int qid,String remark) {
    	Questions questions=questionsRepos.findByQid(qid);
    	User user=questions.getUser();
        emailService.sendusermail(user.getEmail(),"your question deleted by admin",remark);
